...
const LocationSection = [
  {
    img: section2Image1,
    titleText:
      "미래가치를 높여주는<br />반도체 벨트 ",
    contentText:
      "첨단시스템 반도체 클러스터(계획), 반도체 클러스터 일반산업단지<br />L자형 반도체벨트의 비전을 선점하는<br />독보적 프리미엄 브랜드",
  },
  {
    img: section2Image2,
    titleText: "차량 10분내 대형병원 인접<br />의세권을 누리릴 수 있는 프리미엄",
    contentText:
      "의 의세권을 책임지는<br />오래된 의료경력을 갖고 있는<br /> 500병상 규모 명지병원 인접",
  },
  {
    img: section2Image3,
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="김해 레포츠파크 제일풍경채의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다
"
        />
        <meta
          name="keywords"
...
",
      ...
      <p className={styles.screenReaderOnly}>
        ...
        인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 의
      ...
      <div className={styles.textBox}>
        ...
        <div>살수록 높아질 풍경채</div>
        <div>도시를 압도할 자부심 풍경채</div>
      </div>

      <img
        src={page1}
        className={styles.image2}
        alt="김해 레포츠파크 제일풍경채입지환경-image1"
      />
      ...
      <div className={styles.commonBox}>
        ...
        <div className={styles.notice}>
          ※첨단 시스템 반도체 클러스터(계획) : 국토교통부고시 제2024-853호 「 첨단시스템반도체 클러스터 국가산업단지 산업단지계획 및 지형도면 고시」 (2024.12.31)에 의한 것으로 향후 국토교통부에 의해 사업계획이 변경될 수 있습니다.
        </div>
        <div className={styles.notice}>
          ※ 반도체 클러스터 일반산업단지(예정) : 인천시 고시 제2024-775호 「 반도체클러스터 일반산업단지계획(8차 변경) 승인 고시」 (2024.12.26)에 의한 것으로 향후 시행자 (일반산업단지(주))에 의해 사업계획이 변경될 수 있습니다.
        </div>
        <div className={styles.notice}>
          ※이동 공공주택지구(계획) : 국토교통부 고시 제2025-30호「이동 공공주택지구 지정 고시」(2025.01.24)에 의한 것으로 향후 국토교통부에 의해 사업계획이 변경될 수 있습니다.
        </div>
        <div className={styles.notice}>
          ※경강선 연장(추진중) : 인천시 언론보도 “특례시, 경강선 연장’ 제5차 국가철도망계획 반영 건의” (2024.02.08)를 표현한 것으로 국토교통부 사업계획 반영은 미정입니다.
        </div>
        <div className={styles.notice}>
          ※국지도84호선 개설(예정) : 화성시 고시 제2024-11호 「국지도84호선(중리~천리) 도로건설공사 도로구역 결정(변경) 고시」 (2024.01.04)에 의한 것으로 향후 국토교통부에 의해 사업계획이 변경될 수 있습니다.
        </div>
        <div className={styles.notice}>
          ※국도45호선 확장(추진중) : 국토교통부 보도자료 “ 반도체 국가산업단지 지정, 세계 최대의 ‘반도체 특화 도시’로 조성한다” (2024.12.26)에 의한 것으로 국토교통부 사업계획 반영은 미정입니다.
        </div>
        <div className={styles.notice}>
          ※국지도57호선 확장(추진중) : 인천시 언론보도 “특례시, 반도체 국가산단 연계 도로망 구축 박차” (2024.03.28)에 의한 것으로 국토교통부 사업계획 반영은 미정입니다.
        </div>
        <div className={styles.notice}>
          ※동IC 신설(추진중) : 인천시 언론보도 “특례시, 세종-포천고속도로 ‘동IC’ 신설 위한 큰 관문 통과” (2023.12.22)에 의한 것으로 국토교통부 사업계획 반영은 미정입니다.
        </div>
      </div>
